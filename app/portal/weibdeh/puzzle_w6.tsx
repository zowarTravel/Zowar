...
type Locale = "en" | "ar";
type RoundKey = "r1" | "r2" | "r3" | "r4" | "r5" | "r6" | "r7";

// TODO: set MAP_IMAGE to the relevant map for this stop
const MAP_IMAGE = "/images/puzzles/weibdeh/map.png";
...
// TODO: update pin coordinates to match the new map image
...
const CONTENT = {
  en: {
    kicker: "Round · Map Puzzle",        // TODO: fill in round number
    title: "Find the Stop",
    subtitle:
      "Study the clue below, then tap the pin on the map that marks the right location.",
    clueLabel: "Clue",
    clueText: "TODO: Add clue text here.",
    showHint: "Show hint",
    nextHint: "Next hint",
    ...
    hints: [
      "TODO: Hint 1",
      "TODO: Hint 2",
      "TODO: Hint 3 — reveals the answer",
    ],
    mapInstruction: "Tap the pin that matches the clue.",
    wrong: "Not quite — try again.",
    successTitle: "Correct!",
    successBody: "TODO: Add success message.",
    aboutEyebrow: "Your next stop",
    aboutTitle: "TODO: Stop name",
    aboutBody1: "TODO: Add what to do / order at this stop.",
    storyEyebrow: "About this stop",
    storyTitle: "TODO: Stop name",
    storyBody1: "TODO: Add background story paragraph 1.",
    storyBody2: "TODO: Add background story paragraph 2.",
    reset: "Reset",
  },
  ar: {
    kicker: "الجولة · لغز الخريطة",
    title: "اعثر على المحطة",
    subtitle:
      "اقرأ الدليل أدناه، ثم اضغط على الدبوس الذي يُشير إلى الموقع الصحيح.",
    clueLabel: "الدليل",
    clueText: "TODO: أضف نص الدليل هنا.",
    ...
    hints: [
      "TODO: التلميح ١",
      "TODO: التلميح ٢",
      "TODO: التلميح ٣ — يكشف الجواب",
    ],
    mapInstruction: "اضغط على الدبوس الذي يطابق الدليل.",
    wrong: "ليست هذه — حاول مجدداً.",
    successTitle: "إجابة صحيحة!",
    successBody: "TODO: أضف رسالة النجاح هنا.",
    aboutEyebrow: "محطتك التالية",
    aboutTitle: "TODO: اسم المحطة",
    aboutBody1: "TODO: أضف ما يُطلب عند هذه المحطة.",
    storyEyebrow: "عن هذه المحطة",
    storyTitle: "TODO: اسم المحطة",
    storyBody1: "TODO: أضف فقرة القصة الأولى.",
    storyBody2: "TODO: أضف فقرة القصة الثانية.",
    reset: "إعادة",
  },
} as const;
...
export default function PuzzleW6({
  locale,
  roundKey,
  onSolved,
}: {
  ...
  function handlePinSelect(pin: MapPin) {
    ...
    if (pin.isCorrect) {
      ...
      if (!solvedRef.current) {
        ...
        setRoundSolved(roundKey);
        void serverSetRoundSolved(roundKey);
        onSolved?.();
      }
    } else {
      setStatus("wrong");
        ...
        <div className="mt-6">
          ...
          {status === "wrong" && (
            <div
              ...
              style={{ animation: "w6-fade-up .22s ease-out" }}
            >
              {t.wrong}
            </div>
          )}
          ...
          {status === "success" && (
            <>
              ...
              <div
                ...
                style={{ animation: "w6-fade-up .28s ease-out" }}
              >
                <div className="mb-1.5 text-[10px] font-bold uppercase tracking-[0.22em] text-neutral-500">
                  {t.aboutEyebrow}
                </div>
              ...
              <div
                ...
                style={{ animation: "w6-fade-up .34s ease-out" }}
              >
