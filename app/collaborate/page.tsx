...
function safeLocale(x: string | null): Locale {
  return x === "ar" ? "ar" : "en";
}

/** ✅ HARD-CODED ORANGE BULLET (no classes, no vars) */
...
export default function CollaboratePage() {
  ...
  const locale: Locale = safeLocale(searchParams.get("lang"));
          ...
          <aside className={`${glassCard} p-6`}>
            ...
            <form onSubmit={onSubmit} className="mt-5 grid gap-3">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <Field label={`${t.fields.email} • ${t.required}`} name="email" type="email" required />
              ...
              <button
                ...
                style={{
                  backgroundColor: "#f97316",
                  boxShadow: "0 0 0 1px rgba(249,115,22,0.15), 0 0 30px rgba(249,115,22,0.35)",
                }}
              >
