...
// Replace with your Google Business Profile review link from GBP dashboard → "Get more reviews"
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-xl border border-[#4285F4]/25 bg-[#4285F4]/6 px-3.5 py-2 text-xs font-semibold text-[#1a56c4] transition hover:bg-[#4285F4]/12"
                  >
                    <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0" fill="currentColor">
                    ...
                    {isAr ? "قيّمنا على Google" : "Review on Google"}
                  </a>
                  <button
                    type="button"
